...
public class JoystickView extends View {
    ...
    private void initJoystickView() {
        ...
        dbgPaint1.setColor(Color.rgb(255, 0, 0));
        dbgPaint1.setStrokeWidth(1);
        dbgPaint1.setAlpha(100);
        dbgPaint1.setTextSize(30);
        dbgPaint1.setStyle(Paint.Style.FILL_AND_STROKE);

        dbgPaint2 = new Paint(Paint.ANTI_ALIAS_FLAG);
        dbgPaint2.setColor(Color.rgb(0, 255, 0));
        dbgPaint2.setStrokeWidth(1);
        dbgPaint2.setAlpha(100);
        dbgPaint2.setTextSize(30);
        dbgPaint2.setStyle(Paint.Style.FILL_AND_STROKE);
        ...
        handlePaint.setColor(Color.rgb(0, 153, 204));
    ...
    protected void onLayout(boolean changed, int left, int top, int right, int bottom) {
        ...
        Bitmap backTexture = Bitmap.createBitmap(d,d,conf);
        Canvas c = new Canvas(backTexture);
        //Bitmap backTexture = Bitmap.createBitmap(backTexture, 0,0, d*2-1, d*2-1);
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (D) {
            canvas.drawRect(1, 1, getWidth() - 1, getHeight() - 1, dbgPaint1);
            ...
            canvas.drawText("(" + String.format("%.0f, %.1f", radial, angle) + (char) 0x00B0 + ")", handleX - 20, baseY + 39, dbgPaint2);
            canvas.drawText("(" + String.format("%d, %d", cartX, cartY) + ")", handleX - 20, baseY + 59, dbgPaint2);
        }
...
//          Log.d(TAG, String.format("ACTION_MOVE: (%03.0f, %03.0f) => (%03.0f, %03.0f)", x, y, touchX, touchY));
    ...
    private void calcUserCoordinates() {
        ...
        // this do the trick to put atan betwee 0 - 2PI, 0 -360
        angle = Math.atan2(-cartY, cartX);
        angle = (angle/Math.PI*180) + (angle > 0 ? 0 : 360);
